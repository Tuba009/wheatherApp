...
const Account = () => {
  ...
  const [tempName, setTempName] = useState(''); // Temporary name for editing
  ...
  return (
    <View style={{ flex: 1, backgroundColor: 'white' }}>
      ...
      <View style={{ flexDirection: 'row' }}>
        <TouchableOpacity>
          <Icon1 style={{ marginTop: 20, marginLeft: 10 }} name="lock" size={30} color="black" />
        </TouchableOpacity>
        <TouchableOpacity>
          <Icon2 style={{ marginTop: 20, marginLeft: 180 }} name="insert-chart" size={30} color="black" />
        </TouchableOpacity>
        <TouchableOpacity>
          <Icon3 style={{ marginTop: 20, marginLeft: 20 }} name="instagram" size={30} color="black" />
        </TouchableOpacity>
        <TouchableOpacity onPress={() => navigation.navigate('UserDetail' as never)}>
          <Icon4 style={{ marginTop: 20, marginLeft: 20 }} name="grip-lines" size={30} color="black" />
        </TouchableOpacity>
      </View>
      ...
      <View style={{ flexDirection: 'row' }}>
        ...
        <TouchableOpacity>
          <Text style={[styles.button, { width: '70%', marginLeft: 80 }]}>Share Profile</Text>
        </TouchableOpacity>
      </View>
